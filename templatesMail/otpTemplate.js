const otpTemplate = (otp) => {
    ...
    <head>
        ...
        <title>OTP Verifiction Email</title>
        <style>
            body{
    ...
    <body>
        <div class="container">
            ...
            <div class="body">
                <p>Dear User , </p>
                <p>Thank you for registering with Uniemtech. To complete your registration please use the following OTP (One Time Password) to verify your account</p>
